...
Este trabalho contou com o auxílio de ferramentas de inteligência artificial generativa para sumarização de materiais de estudo, organização preliminar de conteúdo e ajustes textuais de clareza, coesão e revisão linguística. A seleção das fontes, a interpretação do conteúdo, a estrutura argumentativa e a responsabilidade acadêmica pelo texto final permanecem sob responsabilidade do autor, em conformidade com orientações contemporâneas de transparência no uso de ferramentas de apoio em produções científicas.
